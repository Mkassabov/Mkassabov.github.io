! function() {
    ...
    function e(e, t) {
        if (e) {
            if (t.element_.classList.contains(t.CssClasses_.mtss_JS_RIPPLE_EFFECT)) {
                var s = document.createElement("span");
                s.classList.add(t.CssClasses_.mtss_RIPPLE_CONTAINER), s.classList.add(t.CssClasses_.mtss_JS_RIPPLE_EFFECT);
                var i = document.createElement("span");
                i.classList.add(t.CssClasses_.mtss_RIPPLE), s.appendChild(i), e.appendChild(s)
            }
    ...
    s = function() {
        ...
        function a(n, a) {
            if (!("object" == typeof n && n instanceof Element)) throw new Error("Invalid argument provided to upgrade mtss element.");
            var l = i("mtss-componentupgrading", !0, !0);
            if (n.dispatchEvent(l), !l.defaultPrevented) {
                ...
                for (var d, h = 0, u = r.length; h < u; h++) {
                    ...
                    var I = i("mtss-componentupgraded", !0, !1);
                    n.dispatchEvent(I)
                }
            }
        }
        ...
        function o(t) {
            ...
            if (c.forEach(function(e) {
                ...
                }), t.constructor.prototype.hasOwnProperty(C)) throw new Error("mtss component classes must not have " + C + " defined as a property.");
        ...
        function d(e) {
            if (e) {
                ...
                var a = i("mtss-componentdowngraded", !0, !1);
        ...
        function h(e) {
            ...
            if (e instanceof Array || e instanceof NodeList)
                ...
                if (!(e instanceof Node)) throw new Error("Invalid argument provided to downgrade mtss nodes.");
                t(e)
            }
        }
        var c = [],
            p = [],
            C = "mtssComponentConfigInternal_";
        return {
            upgradeDom: n,
            upgradeElement: a,
            upgradeElements: l,
        ...
        "classList" in document.createElement("div") && "querySelector" in document && "addEventListener" in window && Array.prototype.forEach ? (document.documentElement.classList.add("mtss-js"), s.upgradeAllRegistered()) : (s.upgradeElement = function() {}, s.register = function() {})
    ...
    window.MaterialButton = o, o.prototype.Constant_ = {}, o.prototype.CssClasses_ = {
        RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_CONTAINER: "mtss-button__ripple-container",
        RIPPLE: "mtss-ripple"
    ...
    window.MaterialCheckbox = r, r.prototype.Constant_ = {
        ...
        INPUT: "mtss-checkbox__input",
        BOX_OUTLINE: "mtss-checkbox__box-outline",
        FOCUS_HELPER: "mtss-checkbox__focus-helper",
        TICK_OUTLINE: "mtss-checkbox__tick-outline",
        RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "mtss-checkbox__ripple-container",
        RIPPLE_CENTER: "mtss-ripple--center",
        RIPPLE: "mtss-ripple",
    ...
    window.MaterialIconToggle = _, _.prototype.Constant_ = {
        ...
        INPUT: "mtss-icon-toggle__input",
        JS_RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "mtss-icon-toggle__ripple-container",
        RIPPLE_CENTER: "mtss-ripple--center",
        RIPPLE: "mtss-ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialMenu = d, d.prototype.Constant_ = {
        ...
        CONTAINER: "mtss-menu__container",
        OUTLINE: "mtss-menu__outline",
        ITEM: "mtss-menu__item",
        ITEM_RIPPLE_CONTAINER: "mtss-menu__item-ripple-container",
        RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE: "mtss-ripple",
        IS_UPGRADED: "is-upgraded",
        ...
        BOTTOM_LEFT: "mtss-menu--bottom-left",
        BOTTOM_RIGHT: "mtss-menu--bottom-right",
        TOP_LEFT: "mtss-menu--top-left",
        TOP_RIGHT: "mtss-menu--top-right",
        UNALIGNED: "mtss-menu--unaligned"
        ...
        if (this.element_) {
            ...
            var s = this.element_.getAttribute("for") || this.element_.getAttribute("data-mtss-for"),
                i = null;
    ...
    window.MaterialProgress = h, h.prototype.Constant_ = {}, h.prototype.CssClasses_ = {
        INDETERMINATE_CLASS: "mtss-progress__indeterminate"
    ...
    window.MaterialRadio = c, c.prototype.Constant_ = {
        ...
        IS_CHECKED: "is-checked",
        IS_UPGRADED: "is-upgraded",
        JS_RADIO: "mtss-js-radio",
        RADIO_BTN: "mtss-radio__button",
        RADIO_OUTER_CIRCLE: "mtss-radio__outer-circle",
        RADIO_INNER_CIRCLE: "mtss-radio__inner-circle",
        RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "mtss-radio__ripple-container",
        RIPPLE_CENTER: "mtss-ripple--center",
        RIPPLE: "mtss-ripple"
    ...
    window.MaterialSlider = p, p.prototype.Constant_ = {}, p.prototype.CssClasses_ = {
        IE_CONTAINER: "mtss-slider__ie-container",
        SLIDER_CONTAINER: "mtss-slider__container",
        BACKGROUND_FLEX: "mtss-slider__background-flex",
        BACKGROUND_LOWER: "mtss-slider__background-lower",
        BACKGROUND_UPPER: "mtss-slider__background-upper",
    ...
    window.MaterialSnackbar = C, C.prototype.Constant_ = {
        ...
        SNACKBAR: "mtss-snackbar",
        MESSAGE: "mtss-snackbar__text",
        ACTION: "mtss-snackbar__action",
        ACTIVE: "mtss-snackbar--active"
    ...
    window.MaterialSpinner = u, u.prototype.Constant_ = {
        mtss_SPINNER_LAYER_COUNT: 4
    }, u.prototype.CssClasses_ = {
        mtss_SPINNER_LAYER: "mtss-spinner__layer",
        mtss_SPINNER_CIRCLE_CLIPPER: "mtss-spinner__circle-clipper",
        mtss_SPINNER_CIRCLE: "mtss-spinner__circle",
        mtss_SPINNER_GAP_PATCH: "mtss-spinner__gap-patch",
        mtss_SPINNER_LEFT: "mtss-spinner__left",
        mtss_SPINNER_RIGHT: "mtss-spinner__right"
    }, u.prototype.createLayer = function(e) {
        var t = document.createElement("div");
        t.classList.add(this.CssClasses_.mtss_SPINNER_LAYER), t.classList.add(this.CssClasses_.mtss_SPINNER_LAYER + "-" + e);
        var s = document.createElement("div");
        s.classList.add(this.CssClasses_.mtss_SPINNER_CIRCLE_CLIPPER), s.classList.add(this.CssClasses_.mtss_SPINNER_LEFT);
        var i = document.createElement("div");
        i.classList.add(this.CssClasses_.mtss_SPINNER_GAP_PATCH);
        var n = document.createElement("div");
        n.classList.add(this.CssClasses_.mtss_SPINNER_CIRCLE_CLIPPER), n.classList.add(this.CssClasses_.mtss_SPINNER_RIGHT);
        for (var a = [s, i, n], l = 0; l < a.length; l++) {
            var o = document.createElement("div");
            o.classList.add(this.CssClasses_.mtss_SPINNER_CIRCLE), a[l].appendChild(o)
        }
        ...
        if (this.element_) {
            for (var e = 1; e <= this.Constant_.mtss_SPINNER_LAYER_COUNT; e++) this.createLayer(e);
            this.element_.classList.add("is-upgraded")
        }
    }, s.register({
        constructor: u,
        classAsString: "MaterialSpinner",
        cssClass: "mtss-js-spinner",
        widget: !0
    });
    var E = function(e) {
        this.element_ = e, this.init()
    ...
    window.MaterialSwitch = E, E.prototype.Constant_ = {
        ...
        INPUT: "mtss-switch__input",
        TRACK: "mtss-switch__track",
        THUMB: "mtss-switch__thumb",
        FOCUS_HELPER: "mtss-switch__focus-helper",
        RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "mtss-switch__ripple-container",
        RIPPLE_CENTER: "mtss-ripple--center",
        RIPPLE: "mtss-ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialTabs = m, m.prototype.Constant_ = {}, m.prototype.CssClasses_ = {
        TAB_CLASS: "mtss-tabs__tab",
        PANEL_CLASS: "mtss-tabs__panel",
        ACTIVE_CLASS: "is-active",
        UPGRADED_CLASS: "is-upgraded",
        mtss_JS_RIPPLE_EFFECT: "mtss-js-ripple-effect",
        mtss_RIPPLE_CONTAINER: "mtss-tabs__ripple-container",
        mtss_RIPPLE: "mtss-ripple",
        mtss_JS_RIPPLE_EFFECT_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events"
    }, m.prototype.initTabs_ = function() {
        this.element_.classList.contains(this.CssClasses_.mtss_JS_RIPPLE_EFFECT) && this.element_.classList.add(this.CssClasses_.mtss_JS_RIPPLE_EFFECT_IGNORE_EVENTS), this.tabs_ = this.element_.querySelectorAll("." + this.CssClasses_.TAB_CLASS), this.panels_ = this.element_.querySelectorAll("." + this.CssClasses_.PANEL_CLASS);
    ...
    window.MaterialTextfield = L, L.prototype.Constant_ = {
        ...
        LABEL: "mtss-textfield__label",
        INPUT: "mtss-textfield__input",
        IS_DIRTY: "is-dirty",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialTooltip = I, I.prototype.Constant_ = {}, I.prototype.CssClasses_ = {
        IS_ACTIVE: "is-active",
        BOTTOM: "mtss-tooltip--bottom",
        LEFT: "mtss-tooltip--left",
        RIGHT: "mtss-tooltip--right",
        TOP: "mtss-tooltip--top"
        ...
        if (this.element_) {
            var e = this.element_.getAttribute("for") || this.element_.getAttribute("data-mtss-for");
    ...
    window.MaterialLayout = f, f.prototype.Constant_ = {
        ...
        CONTAINER: "mtss-layout__container",
        HEADER: "mtss-layout__header",
        DRAWER: "mtss-layout__drawer",
        CONTENT: "mtss-layout__content",
        DRAWER_BTN: "mtss-layout__drawer-button",
        ICON: "material-icons",
        JS_RIPPLE_EFFECT: "mtss-js-ripple-effect",
        RIPPLE_CONTAINER: "mtss-layout__tab-ripple-container",
        RIPPLE: "mtss-ripple",
        RIPPLE_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        HEADER_SEAMED: "mtss-layout__header--seamed",
        HEADER_WATERFALL: "mtss-layout__header--waterfall",
        HEADER_SCROLL: "mtss-layout__header--scroll",
        FIXED_HEADER: "mtss-layout--fixed-header",
        OBFUSCATOR: "mtss-layout__obfuscator",
        TAB_BAR: "mtss-layout__tab-bar",
        TAB_CONTAINER: "mtss-layout__tab-bar-container",
        TAB: "mtss-layout__tab",
        TAB_BAR_BUTTON: "mtss-layout__tab-bar-button",
        TAB_BAR_LEFT_BUTTON: "mtss-layout__tab-bar-left-button",
        TAB_BAR_RIGHT_BUTTON: "mtss-layout__tab-bar-right-button",
        TAB_MANUAL_SWITCH: "mtss-layout__tab-manual-switch",
        PANEL: "mtss-layout__tab-panel",
        ...
        IS_UPGRADED: "is-upgraded",
        IS_ANIMATING: "is-animating",
        ON_LARGE_SCREEN: "mtss-layout--large-screen-only",
        ON_SMALL_SCREEN: "mtss-layout--small-screen-only"
        ...
        cssClass: "mtss-js-layout"
    });
    var b = function(e) {
        this.element_ = e, this.init()
    };
    window.MaterialDataTable = b, b.prototype.Constant_ = {}, b.prototype.CssClasses_ = {
        DATA_TABLE: "mtss-data-table",
        SELECTABLE: "mtss-data-table--selectable",
        SELECT_ELEMENT: "mtss-data-table__select",
        ...
        return t ? function() {
            ...
            var t, i;
            if (e.checked)
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".mtss-checkbox"), i.MaterialCheckbox.check(), s[t].classList.add(this.CssClasses_.IS_SELECTED);
            else
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".mtss-checkbox"), i.MaterialCheckbox.uncheck(), s[t].classList.remove(this.CssClasses_.IS_SELECTED)
        }.bind(this) : void 0
    }, b.prototype.createCheckbox_ = function(e, t) {
        var i = document.createElement("label"),
            n = ["mtss-checkbox", "mtss-js-checkbox", "mtss-js-ripple-effect", this.CssClasses_.SELECT_ELEMENT];
        i.className = n.join(" ");
        var a = document.createElement("input");
        return a.type = "checkbox", a.classList.add("mtss-checkbox__input"), e ? (a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED), a.addEventListener("change", this.selectRow_(a, e))) : t && a.addEventListener("change", this.selectRow_(a, null, t)), i.appendChild(a), s.upgradeElement(i, "MaterialCheckbox"), i
    ...
    window.MaterialRipple = S, S.prototype.Constant_ = {
        ...
        RIPPLE_CENTER: "mtss-ripple--center",
        RIPPLE_EFFECT_IGNORE_EVENTS: "mtss-js-ripple-effect--ignore-events",
        RIPPLE: "mtss-ripple",
        IS_ANIMATING: "is-animating",
        IS_VISIBLE: "is-visible"
        ...
        cssClass: "mtss-js-ripple-effect",
        widget: !1
    })
}();
